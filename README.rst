...
Let's take the following scenario:
    ...
    However, what if one of these actors, the receiver for instance, uses an esoteric implementation that cannot be shared across mutliple applications because it is particular to that one web app?
